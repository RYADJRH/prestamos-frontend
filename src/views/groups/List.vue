  ...
  <div class="flex flex-col gap-2">
    ...
    <div class="md:flex md:justify-between">
      ...
      <div class="md:flex block">
        ...
        <r-form-group title="Status:" class="mt-2">
          <r-select
            v-model="selectFiltroArchivo"
            :items="groupStore.getitemsFiltro"
            class="md:w-40 w-full mt-2 md:mt-0"
          ></r-select>
        </r-form-group>
      </div>
    </div>
    ...
    <div class="w-full">
      <div class="flex flex-wrap -mx-2">
        <div
          class="md:w-1/3 w-full px-2 my-2"
        ...
        >
          <CardGroup
            ...
            @update:group="openModalEditGroup"
            @selected:group="selectedGroup"
          ></CardGroup>
        </div>
        <div
          class="bg-white p-10 w-full flex justify-center text-xl text-sky-800 rounded-md shadow-sm border"
    ...
    <template #content>
      <form @submit.prevent="sendFormGroup">
        <r-form-group title="Nombre del grupo" class="mb-6">
          <r-input
            v-model="newGroup.name_group"
            type="text"
            placeholder="Grupo el suchil"
            :state-error="
        ...
        <r-form-group title="Fecha de inicio:" class="mb-6">
          <r-input
            v-model="newGroup.created_group"
            type="date"
            :state-error="
        ...
        <r-form-group title="Dia de pago:" class="mb-6">
          <div class="flex flex-wrap gap-2 mt-2">
            <r-btn-radio
              v-for="(item, index) in daysWeek"
              :key="index"
              v-model="(newGroup.day_payment as number)"
              :id="'day-payment-' + item"
              :value="DayWeek[item]"
              name="day-payment"
              variant="primary"
